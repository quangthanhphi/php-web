...
?>
    ...
    <section class="breadcrumb-section set-bg" style="height: 300px;" data-setbg="images/breadcrumb.jpeg">
        <!-- <div class="container">
            <div class="row">
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            <div class="product__discount__slider owl-carousel">
                                    <?php
                                         $sql_str = "select products.id as pid, images,price, disscounted_price, products.name as pname, categories.name as cname, round((price - disscounted_price)/price*100) as discount 
                                         from products, categories
                                         where products.category_id = categories.id 
                                         order by discount desc limit 0,6; ";
                                         $result = mysqli_query($conn, $sql_str);
                                         while ($row = mysqli_fetch_assoc($result)) {   
                                            $anh_arr = explode(';', $row['images']); 
                                    ?>
