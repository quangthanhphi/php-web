        ...
        <div class="container">
            <div class="row">
                ...
                <div class="categories__slider owl-carousel">
                    ...
                    ?>
                        <div class="col-lg-3">
                            <div class="categories__item set-bg" data-setbg="images/computer.webp" >
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                <?php
                require('./db/conn.php');
                $sql_str = "select products.id as pid, products.name as pname, images, price, categories.slug as cslug
