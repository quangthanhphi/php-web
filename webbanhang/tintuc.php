    ...
    $sql_str = "select
    *, news.id as nid
     from newscategories, news
     where news.newscategory_id = newscategories.id and news.id = $idsp
     order by nid";
    $result = mysqli_query($conn, $sql_str);
    ($row = mysqli_fetch_assoc($result));
    $anh = $row["avatar"];
    // Giả sử $row["created_at"] chứa ngày tháng từ cơ sở dữ liệu
...
$formatted_date = date("d M Y", strtotime($created_at));
    ...
    <section class="blog-details-hero set-bg" data-setbg="bg-white">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="blog__details__hero__text text-center"> <!-- Added 'text-center' class -->
                        ...
                        <!-- <ul> -->
                            ...
                            <!-- <li></li> -->
                        <!-- </ul> -->
                        <h4 class="mx-auto" style="max-width: 66.6666666667%;"><?=$row["summary"];?></h4> <!-- Added 'mx-auto' class -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="related-blog spad">
        <div class="container">
            ...
            <div class="row">
                <?php
                $sql_str4 = 'select * from news where newscategory_id='.$row['newscategory_id']
                ." and id <> " . $row['id'];
